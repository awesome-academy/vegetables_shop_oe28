                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="{{ route('products.index') }}">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c_product }}</div>
                                </div>
                            </a>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="{{ route('posts.index') }}">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c_post }}</div>
                                </div>
                            </a>
                            <div class="col-auto">
                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="{{ route('supliers.index') }}">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c_supplier }}</div>
                                </div>
                            </a>
                            <div class="col-auto">
                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="{{ route('categories.index') }}">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c_category }}</div>
                                </div>
                            </a>
                            <div class="col-auto">
                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="{{ route('orders.index') }}">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c_order }}</div>
                                </div>
                            </a>
                            <div class="col-auto">
                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="{{ route('import-bills.index') }}">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c_importBill }}</div>
                                </div>
                            </a>
                            <div class="col-auto">
                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
