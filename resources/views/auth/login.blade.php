    ...
    <div class="container-login100 img-container">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            ...
            <form action="{{ route('admin.post_login') }}" class="login100-form validate-form" method="POST">
                @csrf
                <span class="login100-form-title p-b-37">{{ trans('templates.login_admin') }}</span>
                ...
                <div class="wrap-input100 validate-input m-b-20">
                    <input class="input100" type="email" name="email" placeholder="{{ trans('templates.email') }}">
                    <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-25">
                    <input class="input100" type="password" name="password" placeholder="{{ trans('templates.password') }}">
                    <span class="focus-input100"></span>
                </div>
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn">
                        {{ trans('templates.sign_in') }}
                    </button>
                </div>
            </form>
        </div>
